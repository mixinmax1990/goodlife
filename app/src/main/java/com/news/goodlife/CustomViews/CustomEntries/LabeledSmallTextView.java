...
public class LabeledSmallTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public LabeledSmallTextView(@NonNull Context context) {
        super(context);
    }

    public LabeledSmallTextView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void setPaints() {
        ...
        roundedStrokePaint.setTextSize(11 * getResources().getDisplayMetrics().scaledDensity);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        roundedStrokePaint.setStyle(Paint.Style.STROKE);
        canvas.drawRoundRect(new RectF(0 + paddingStartEnd,0 + paddingTop, getWidth() - paddingStartEnd, getHeight() - paddingStartEnd), 20,20, roundedStrokePaint);

        backgroundBox.setColor(backgroundColor);
        backgroundBox.setAlpha(255);
        canvas.drawRect(new RectF(20, 0, 60 + text_width , 50), backgroundBox);

        roundedStrokePaint.setStyle(Paint.Style.FILL);
        canvas.drawText(label, 40, paddingTop + (int)(paddingTop/2), roundedStrokePaint);
    }
