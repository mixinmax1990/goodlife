...
public class LiquidViewCompare extends CardView {
    ...
    public LiquidViewCompare(@NonNull Context context) {
        super(context);
    }

    public LiquidViewCompare(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    private void setPaints() {
        ...
        liquidPaint.setColor(Color.parseColor(getTag().toString()));
