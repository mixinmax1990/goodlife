...
public class CashflowMonthAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public CashflowMonthAdapter(Context context, List<toCalendarViewTransition> allTransitionNames) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch(viewType){
            ...
            case 2:
                //Inflate MonthName
                View v2 = inflater.inflate(R.layout.month_cashflow_monthstart_item, parent, false);
            ...
            default:
                //inflate Day
                View v5 = inflater.inflate(R.layout.month_cashflow_day_item, parent, false);
